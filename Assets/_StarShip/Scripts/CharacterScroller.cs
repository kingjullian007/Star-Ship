...
namespace _StarShip
{
    public class CharacterScroller : MonoBehaviour
    {
        ...
        public static event System.Action<int> ChangeCharacter;
        ...
        void Start()
        {
            ...
            for (int i = 0; i < CharacterManager.Instance.characters.Length; i++)
            {
                ...
                character.transform.GetChild(0).gameObject.layer = LayerMask.NameToLayer("CharacterSelectionUI");
            }
        ...
        public void SelectCharacter()
        {
            ...
            if (ChangeCharacter != null)
                ChangeCharacter(CharacterManager.Instance.CurrentCharacterIndex);
        }
    }
}